...
if __name__ == '__main__': 
    ...
    with open(sys.argv[1]) as f:
        for line in enumerate(f): 
            ...
            company_domain = ""
            print(fname + lname + company_domain)           # johndoe
            print(lname + fname + company_domain)           # doejohn
            print(fname + '.' + lname + company_domain)     # john.doe
            print(lname + '.' + fname + company_domain)     # doe.john
            print(lname + fname[0] + company_domain)        # doej
            print(fname[0] + lname + company_domain)        # jdoe
            print(lname[0] + fname + company_domain)        # djoe
            print(fname[0] + '.' + lname + company_domain)  # j.doe
            print(lname[0] + '.' + fname + company_domain)  # d.john
            print(fname + company_domain)                   # john
            print(lname + company_domain)                   # joe